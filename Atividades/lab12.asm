...
; Procedimentos:
; - LE_VET: Lê um vetor da entrada padrão e armazena na memória.
; - IMP_VET: Imprime um vetor na tela.
; - CP_VET: Copia um vetor de origem para um vetor de destino.
; - CMP_CAR: Conta quantas vezes um caractere específico aparece no vetor.
